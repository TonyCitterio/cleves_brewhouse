    ...
    <>
      <div className={classes.introHowToBrew}>
        ...
        <div>
          ...
          <p>
            Jag hjälper dig gärna med att komma igång med att brygga så jag har
            satt ihop en liten guide du kan följa för att komma igång!
          </p>
        </div>
      </div>
      <div className={classes.ingredients}>
        ...
        <div>
          ...
          <p>
            ...
            att kolla hur mycket socker det finns kvar i vörten. Ölet mäts innan
            och efter jäsning.
          </p>
        </div>
        <div>
